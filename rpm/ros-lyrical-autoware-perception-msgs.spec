...
%global pkg_name autoware_perception_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-autoware-perception-msgs
Version:        1.11.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.11.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.11.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.11.0-1
- Autogenerated by Bloom
